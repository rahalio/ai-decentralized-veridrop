/**
 * Rewards Services - Application Layer Export
 *
...
/**
 * Rewards Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for rewards domain.
 */
