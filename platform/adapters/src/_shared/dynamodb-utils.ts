 ...
 *
 * @returns The core table name (e.g., "veridrop-core-dev")
 ...
 *
 * @returns The base table name (e.g., "veridrop-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "veridrop-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "veridrop-app-realtime-dev")
