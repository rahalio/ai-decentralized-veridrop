 ...
 * Arbitration Domain
 *
 * Barrel export for arbitration service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @veridrop/core only
...
// ============================================================================
export { arbitrationService } from './arbitration.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { arbitrationFacade } from './facade';
