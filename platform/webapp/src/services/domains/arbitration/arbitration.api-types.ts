/**
 * Arbitration API Types
 *
 * API contract types come from @veridrop/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @veridrop/core)
// ============================================================================
...
export type {
  // Add types from @veridrop/core/arbitration
} from "@veridrop/core";

// Re-export with alias for backward compatibility if needed
// export type CoreArbitrationItem = ArbitrationItem;
