 ...
 *
 * @see @veridrop/core/participants for the source schemas
 */

import { participantsSchemas as coreParticipantsSchemas } from "@veridrop/core/participants";
